...
namespace Note.Infra.Data.SqlServer.Migrations
{
    ...
    [Migration("20200223205258_UpdateBookmark_RemoveTitle")]
    partial class UpdateBookmark_RemoveTitle
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Note.Core.Entities.Bookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Note.Core.Entities.Bookmark", b =>
                {
                    b.HasOne("Note.Core.Entities.Page", "Page")
                        .WithMany()
                        .HasForeignKey("PageId");

                    b.HasOne("Note.Core.Entities.User", "User")
                        .WithMany()
